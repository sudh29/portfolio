    ...
    posts: [
      {
        ...
        excerpt: 'A deep dive into the five fundamental principles of object-oriented design.',
        content: 'The SOLID principles are a set of five design principles intended to make software designs more understandable, flexible, and maintainable...'
      },
      {
        slug: 'cap-theorem',
        title: 'CAP Theorem',
        excerpt: 'Understanding the trade-offs between Consistency, Availability, and Partition Tolerance.',
        content: 'The CAP theorem states that it is impossible for a distributed data store to simultaneously provide more than two out of the following three guarantees: Consistency, Availability, and Partition Tolerance...'
      },
      {
        slug: 'acid-properties',
        title: 'ACID Properties',
        excerpt: 'Exploring the core principles of database transaction reliability.',
